...
class _SignInState extends State<SignIn> {
  ...
  Future<BaseModel<Login>> callApiForLogin() async {
    Map<String, dynamic> body = {
      "email": email.text,
      // "email": 'kashan.badar@catalyic.com',
    ...
    try {
      ...
      if(response.success == true ) {
        ...
        SharedPreferenceHelper.setInt(Preferences.is_filled, int.parse(response.data!.isFilled!.toString()));
        ...
        if(response.data != null  && response.data!.verify.toString() == "0"){
